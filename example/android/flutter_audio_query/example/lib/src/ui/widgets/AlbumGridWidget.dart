...
class AlbumGridWidget extends StatelessWidget {
  ...
  AlbumGridWidget({required List<AlbumInfo>? albumList, Function(AlbumInfo info)? onAlbumClicked})
            ...
            children: <Widget>[
              (album.albumArt == null)
                  ? FutureBuilder<Uint8List>(
                      future: audioQuery.getArtwork(type: ResourceType.ALBUM, id: album.id),
                      builder: (_, snapshot) {
